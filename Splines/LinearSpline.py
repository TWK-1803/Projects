class LinearSpline:
    ...
    def getEndPoint(self, t):
        ...
        if currentsegment == len(self.pointCloud) - 1:
            ...
            vx = (
                self.pointCloud[currentsegment + 1][0]
                - self.pointCloud[currentsegment][0]
            ) * u
            vy = (
                self.pointCloud[currentsegment + 1][1]
                - self.pointCloud[currentsegment][1]
            ) * u
            return [
                self.pointCloud[currentsegment][0] + vx,
                self.pointCloud[currentsegment][1] + vy,
            ]
